...
<%--
<%@page import="tooltwist.bootstrap.productionHelpers.NavBarProductionHelper"%>
--%>
...
<!-- ********** INSERT HTML HERE ********** -->
<div %%idDefinition%% class="NavBar" style="width:200px; border-style:solid; border-width:1px; text-align: center;">
	navBar

	<!-- Display an image 
	<img src="%%URL(bootstrap/images/myImage.png)%%"/>
	 -->
