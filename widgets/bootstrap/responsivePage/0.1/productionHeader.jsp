...
%%headerCode%%
    ...
    <!-- Bootstrap -->
    <link href="%%URL(/ttsvr/bootstrap/css/build/bootstrap.min.css)%%" rel="stylesheet" media="screen">
    <link href="%%URL(/ttsvr/bootstrap/css/build/jasny-bootstrap.min.css)%%" rel="stylesheet" media="screen">
    <link href="%%URL(/ttsvr/bootstrap/css/build/font-awesome.min.css)%%" rel="stylesheet" media="screen">
