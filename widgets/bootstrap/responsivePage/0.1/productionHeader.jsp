...
<script>
	(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'fgtm.start':new Date().getTime(),event:'fgtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='//www.googletagmanager.com/fgtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','<%=Config.getValue("fgtm.containerId")%>');
</script>
